...
from app.core.ai_config import LOW_CONFIDENCE_THRESHOLD, MODEL_VERSION
from app.schemas.ai import DataQuality, HazardType, RelocationRequest, ReportRequest, RiskLevel, RiskRequest, ShelterData
...
def classify_report(request: ReportRequest) -> dict:
    ...
    keywords = {
        "BLOCKED_ROAD": ("road", "blocked", "traffic"),
        "FLOODING": ("flood", "water", "inundated"),
        "LANDSLIDE": ("landslide", "mudslide"),
        "DAMAGED_BRIDGE": ("bridge", "collapsed"),
        "SHELTER_OVERFLOW": ("shelter", "full", "overflow"),
        "FIRE": ("fire", "smoke", "burning"),
        "BUILDING_DAMAGE": ("building", "crack", "collapsed house"),
        "MEDICAL_EMERGENCY": ("injury", "ambulance", "medical")
    }
